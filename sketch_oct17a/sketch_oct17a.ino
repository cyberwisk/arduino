...
#define PIN_P1         6   // switch player 1 to PIN and GND
...
void setup() {
  ...
  if ((digitalRead(PIN_P1)==1)) //push switch 1 on reset for activate physic
  {
    set_ramp(12,90,100,110);    // ramp centred in LED 100 with 10 led fordward and 10 backguard 
    set_ramp(12,190,200,210);    // ramp centred in LED 100 with 10 led fordward and 10 backguard 
    set_ramp(12,40,50,60);    // ramp centred in LED 100 with 10 led fordward and 10 backguard 
